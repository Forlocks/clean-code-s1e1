...
var incompleteTaskHolder=document.querySelector(".function__to-do__list");//ul of outstanding tasks
var completedTasksHolder=document.querySelector(".function__complete__list");//completed tasks
...
var createNewTaskElement=function(taskString){
  ...
  editInput.type="text";
  editInput.className="input input-text task-name";
  ...
  deleteButtonImg.className="task-delete-img";
...
var taskIncomplete=function(){
  ...
  //Append the task list item to the #outstanding-tasks.
  var listItem=this.parentNode;
  incompleteTaskHolder.appendChild(listItem);
  bindTaskEvents(listItem,taskCompleted);
}
...
for (var i=0; i<completedTasksHolder.children.length;i++){
  //bind events to list items chldren(outstanding-tasks)
